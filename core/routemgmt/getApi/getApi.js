 ...
 *   __ow_user            Required if namespace not specified. Namespace of API author
...
function main(message) {
  ...
  if (message.__ow_user) message.namespace = message.__ow_user;
...
function validateArgs(message) {
  ...
  if(!message.__ow_user && !message.namespace) {
    return '__ow_user or namespace is required.';
  }
