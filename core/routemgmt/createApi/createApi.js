...
function main(message) {
  ...
  // 1. LEGACY.  No access token provided. Use gwUser/gwPwd if provided. Use API GW /v1; basic/no auth
  // 2. V2 OPEN. Access token provided. gwUser/gwPwd not provided. Use API GW /v2; no auth
  // 3. V2 BLUE. Access token provided. gwUser/gwPwd provided. Use API GW /v2; bearer auth
  if (message.accesstoken) {
    var apiDocId;
