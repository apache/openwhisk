...
object Config extends Logging {
    ...
    /**
     * Read a Map of key-value pairs from the Consul service -- store them in the
    ...
    /**
     * Read a Map of key-value pairs from the environment (sys.env) -- store them in the
     * mutable properties object.
     */
    ...
    /**
     * Check that the properties object defines all the required properties.
     *
