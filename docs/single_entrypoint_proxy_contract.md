...
|----------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------|
| Hello World                            | <code>function main() {<br> return {payload: 'Hello World!'};<br>}</code>                                                                                                                                                                             | {<br> "value": {<br>   "name": "Joe",<br>   "place": "TX"<br> }<br>}</code>       | <code>{<br>  "payload": 'Hello World!'<br>}</code>                                                                                                                                                                                                                                                                                                                                                  | 200                                         | application/json                   |                                                                                                                                                       |                        |
| Hello World With Params                | <code>function main(params) {<br>  return { payload: 'Hello ' + params.name + ' from ' + params.place +  '!' };<br>}</code>                                                                                                                           | <code>{<br> "value": {<br>   "name": "Joe",<br>   "place": "TX"<br> }<br>}</code> | <code>{<br>  "payload": "Hello Joe from TX!"<br>}</code>                                                                                                                                                                                                                                                                                                                                            | 200                                         | application/json                   |                                                                                                                                                       |                        |
| Web Action Hello World (With Input)    | <code>function main({name}) {<br>  var msg = 'you did not tell me who you are.';<br>  if (name) {<br>    msg = `hello \({name}`<br>  }<br>  return {body: `&lt;html&gt;&lt;body&gt;&lt;h3&gt;{msg}&lt;/h3&gt;&lt;/body&gt;&lt;/html&gt;`}<br>}</code> | <code>{<br>  "value": {<br>    "name": "Joe"<br>  }<br>}</code>                   | <code>&lt;html&gt;&lt;body&gt;&lt;h3&gt;hello Joe&lt;/h3&gt;&lt;/body&gt;&lt;/html&gt;</code>                                                                                                                                                                                                                                                                                                       | 200                                         | text/html                          |                                                                                                                                                       |                        |
| Web Action Hello World (Without Input) | &lt;Same as above&gt;                                                                                                                                                                                                                                 | n/a                                                                               | <code>&lt;html&gt;&lt;body&gt;&lt;h3&gt;you did not tell me who you are.&lt;/h3&gt;&lt;/body&gt;&lt;/html&gt;</code>                                                                                                                                                                                                                                                                                | 200                                         | text/html                          |                                                                                                                                                       |                        |
| Web Action Raw                         | <code>function main(params) {<br>  return { response: params };<br>}</code>                                                                                                                                                                           | <code>{<br>  "value": {<br>    "name": "Joe"<br>  }<br>}</code>                   | <code>{  "response": {<br>    "__ow_body": "eyJuYW1lIjoiSm9lIn0=",<br>    "__ow_query": {},<br>    "__ow_user": "",<br>    "__ow_method": "POST",<br>    "__ow_headers": {<br>      "host": "localhost",<br>      "user-agent": "curl/7.54.0",<br>      "accept": "*/*",<br>      "content-type": "application/json",<br>      "content-length": "394"<br>    },<br>    "__ow_path": ""<br>  }<br>} | 200                                         | application/json                   | OpenWhisk controller plays an important role in handling web actions and that's why when run from OpenWhisk the response is lacking __OW_* parameters | __OW_ACTION_RAW=true   |
| run sample with init that does nothing | No code Init'd                                                                                                                                                                                                                                        | No Input                                                                          | No Output                                                                                                                                                                                                                                                                                                                                                                                           | Init should 403</br>Run should 500          |                                    |                                                                                                                                                       |                        |
| deploy a zip based script              | Zipped version of Hello World:<code>function main() {<br>  return {payload: 'Hello World!'};<br>}</code>                                                                                                                                              | <code>{ "value": {<br>   "name": "Joe",<br>   "place": "TX"<br> }<br>}</code>     | <code>{  "payload": 'Hello World!'<br>}<code><br>                                                                                                                                                                                                                                                                                                                                                   | Init should 200</br>Run should 200          | application/json                   |                                                                                                                                                       |                        |
|                                        | accept a src not-main action                                                                                                                                                                                                                          | <code>function hello() {<br>  return {payload: 'Hello World!'};<br>}</code>       | <code>{<br> "value": {<br>   "name": "Joe",<br>   "place": "TX"<br>  }<br>}</code>                                                                                                                                                                                                                                                                                                                  | <code>{  "payload": 'Hello World!' }</code> | Init should 200</br>Run should 200 | application/json                                                                                                                                      | __OW_ACTION_MAIN=hello |
| accept a zipped src not-main action    | zipped:<code>function hello() {<br>  return {payload: 'Hello World!'};<br>}</code>                                                                                                                                                                    | <code>{ "value": {<br>   "name": "Joe",<br>   "place": "TX"<br> }<br>}</code>     | <code>{ "payload": "Hello World!" }                                                                                                                                                                                                                                                                                                                                                                 | Init should 200</br>Run should 200          | application/json                   |                                                                                                                                                       | __OW_ACTION_MAIN=hello |

## Implementations

### [NodeJS](https://github.com/apache/openwhisk-runtime-nodejs)
---
* [Hello World](https://github.com/apache/openwhisk-runtime-nodejs/tree/master/tests/src/test/knative/helloworld)
* [Hello World with Params](https://github.com/apache/openwhisk-runtime-nodejs/tree/master/tests/src/test/knative/helloworldwithparams)
* [Web Action Hello World](https://github.com/apache/openwhisk-runtime-nodejs/tree/master/tests/src/test/knative/webactionhelloworld)
* [Web Action Raw](https://github.com/apache/openwhisk-runtime-nodejs/tree/master/tests/src/test/knative/webactionraw)
