...
func (s *PackageService) List(options *PackageListOptions) ([]Package, *http.Response, error) {
    ...
    resp, err := s.client.Do(req, &packages, DoNotProcessTimeOut)
    if err != nil {
...
func (s *PackageService) Get(packageName string) (*Package, *http.Response, error) {
    ...
    p := new(Package)
    resp, err := s.client.Do(req, &p, DoNotProcessTimeOut)
    if err != nil {
        Debug(DbgError, "s.client.Do() error - HTTP req %s; error: '%s'\n", req.URL.String(), err)
        return nil, resp, err
    }
...
func (s *PackageService) Delete(packageName string) (*http.Response, error) {
    ...
    resp, err := s.client.Do(req, nil, DoNotProcessTimeOut)
    if err != nil {
        Debug(DbgError, "s.client.Do() error - HTTP req %s; error: '%s'\n", req.URL.String(), err)
        return resp, err
    }
...
func (s *PackageService) Refresh() (*BindingUpdates, *http.Response, error) {
    ...
    resp, err := s.client.Do(req, updates, DoNotProcessTimeOut)
    if err != nil {
        Debug(DbgError, "s.client.Do() error - HTTP req %s; error: '%s'\n", req.URL.String(), err)
        return nil, resp, err
    }
