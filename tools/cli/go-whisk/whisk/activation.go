...
func (s *ActivationService) List(options *ActivationListOptions) ([]Activation, *http.Response, error) {
    ...
    resp, err := s.client.Do(req, &activations, DoNotProcessTimeOut)
    if err != nil {
...
func (s *ActivationService) Get(activationID string) (*Activation, *http.Response, error) {
    ...
    a := new(Activation)
    resp, err := s.client.Do(req, &a, DoNotProcessTimeOut)
    if err != nil {
        Debug(DbgError, "s.client.Do() error - HTTP req %s; error '%s'\n", req.URL.String(), err)
        return nil, resp, err
    }
...
func (s *ActivationService) Logs(activationID string) (*Activation, *http.Response, error) {
    ...
    resp, err := s.client.Do(req, &activation, DoNotProcessTimeOut)
    if err != nil {
        Debug(DbgError, "s.client.Do() error - HTTP req %s; error '%s'\n", req.URL.String(), err)
        return nil, resp, err
    }
...
func (s *ActivationService) Result(activationID string) (*Response, *http.Response, error) {
    ...
    r := new(Response)
    resp, err := s.client.Do(req, &r, DoNotProcessTimeOut)
    if err != nil {
        Debug(DbgError, "s.client.Do() error - HTTP req %s; error '%s'\n", req.URL.String(), err)
        return nil, resp, err
    }
