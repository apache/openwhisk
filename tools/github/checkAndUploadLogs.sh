...
test -z "$LOG_BUCKET" && echo "LOG_BUCKET is empty"
...
# check variables
for i in LOG_BUCKET AWS_ACCESS_KEY_ID AWS_SECRET_ACCESS_KEY AWS_REGION
do
  if test -z "${!i}"
...
BUCKET_URL="https://$LOG_BUCKET.s3.$AWS_REGION.amazonaws.com"
