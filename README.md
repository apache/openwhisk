...
**Tip:** By default the build will be timeout in half an hour, if you want to change that, you could modify the '240' to a bigger value such as '480' in `docker.gradle`.
