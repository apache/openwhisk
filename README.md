...
**Tip:** By default, each `docker` command will timeout after 840 seconds (12 minutes). If you're on a really slow connection, this might be too short. You can modify the timeout value in [`docker.gradle`](https://github.com/openwhisk/openwhisk/blob/master/docker.gradle#L22) as needed.
