...
The comparisson of the thresholds is against the mean response times of the warm activations.
...
INCLUDE_NODE            (default: true)
INCLUDE_PYTHON          (default: true)
INCLUDE_SWIFT           (default: true)
INCLUDE_JAVA            (default: true)
```
