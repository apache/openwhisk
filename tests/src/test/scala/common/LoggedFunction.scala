...
class LoggedFunction9[A1, A2, A3, A4, A5, A6, A7, A8, A9, B](body: (A1, A2, A3, A4, A5, A6, A7, A8, A9) => B)
    extends Function9[A1, A2, A3, A4, A5, A6, A7, A8, A9, B] {
  val calls = mutable.Buffer[(A1, A2, A3, A4, A5, A6, A7, A8, A9)]()

  override def apply(v1: A1, v2: A2, v3: A3, v4: A4, v5: A5, v6: A6, v7: A7, v8: A8, v9: A9): B = {
    calls += ((v1, v2, v3, v4, v5, v6, v7, v8, v9))
    body(v1, v2, v3, v4, v5, v6, v7, v8, v9)
  }
}
...
object LoggedFunction {
  ...
  def apply[A1, A2, A3, A4, A5, A6, A7, A8, A9, B](body: (A1, A2, A3, A4, A5, A6, A7, A8, A9) => B) =
    new LoggedFunction9[A1, A2, A3, A4, A5, A6, A7, A8, A9, B](body)
}
