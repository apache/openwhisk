...
object OldWhiskRule
    ...
    override def cacheKeyForUpdate(t: OldWhiskRule) = t.docid.asDocInfo.asCacheKey
}
...
object OldWhiskTrigger
    ...
    override def cacheKeyForUpdate(t: OldWhiskTrigger) = t.docid.asDocInfo.asCacheKey
}
