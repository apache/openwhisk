...
public class CLISwiftTests {
    ...
    public void helloWorldSwift() throws Exception {
        final String actionName = "helloSwift";

        long start = System.currentTimeMillis();

        try {
            wsk.sanitize(Action, actionName);
            wsk.createAction(actionName, TestUtils.getCatalogFilename("samples/hello.swift"));
